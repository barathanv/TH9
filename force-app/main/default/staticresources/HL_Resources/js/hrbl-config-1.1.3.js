/* globals kendo */
/* exported _resolveScope,simpleMediator,MvvmConfiguration */
...
// prototypes
Function.prototype.instantiate = function (constructorArguemnts) { // jshint ignore:line
    var context = this,
        invokable = function () {
...
var viewModelHelpers = (function ($, kendo) {
        ...
        k.data.binders.widget.centerWindow = k.data.Binder.extend({
            init: function (widget, bindings, options) {
                try {
                    ...
                    if (flag && widget && widget.center) { widget.center(); }
                } catch (error) {
                    logger.log(error);
                }
            },
    ...
    var wire = (function () {
        ...
        var initializeModel = function (instance) {
            if (instance && instance[configuration.init]) { instance[configuration.init](); }
        };

        var activateLoaders = function () {
            for (var modelName in sharedInstances) {
                if (sharedInstances[modelName]) {
    ...
    var mvvmUtil = (function () {
        ...
        var genericDataLoader = function (obj) {
            ...
            this.useCache = (typeof this.useCache === 'undefined') ? true : this.useCache;
        ...
        var toLoadable = function (obj) {
            ...
            obj.canLoad = obj.canLoad !== false ? true : false;
...
HL.Util.Browser = {
    ...
    IE: function () {
        ...
        jscriptVersion = new Function("/*@cc_on return @_jscript_version; @*/")(); // jshint ignore:line
...
HL.Cookie = (function () {
    ...
    var getCookie = function (tempName, value) { // jshint maxdepth:5
        var name = tempName + "=";
